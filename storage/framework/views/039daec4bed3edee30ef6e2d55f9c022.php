...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="space-y-1.5">
        ...
        <input type="number" name="min_stock" min="0" value="<?php echo e(old('min_stock', $product->min_stock)); ?>" class="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl text-xs font-bold text-slate-800 focus:ring-2 focus:ring-indigo-500/20 outline-none transition-colors">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="space-y-1.5">
          ...
          <input type="number" name="price" step="0.01" value="<?php echo e(old('price', $product->price)); ?>" 
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="space-y-1.5">
          ...
          <select name="unit" 
            ...
            <?php $__currentLoopData = ['pcs','bks','lbr','botol','pak','rim','kg','galon','paket','liter']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($u); ?>" <?php echo e((string)old('unit', $product->unit) === (string)$u ? 'selected' : ''); ?>><?php echo e(strtoupper($u)); ?></option>
      ...
      <div class="space-y-1.5">
        ...
        <select name="category_id" 
          ...
          <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($cat->id); ?>" <?php echo e((string)old('category_id', $product->category_id) === (string)$cat->id ? 'selected' : ''); ?>><?php echo e($cat->name); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="space-y-1.5">
        ...
        <textarea name="description" rows="4" class="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl text-xs font-bold text-slate-800 focus:ring-2 focus:ring-indigo-500/20 outline-none transition-colors"><?php echo e(old('description', $product->description)); ?></textarea>
...
<?php echo $__env->make(($isMobile ?? false) ? 'layouts.mobile' : 'layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SI-LARANG\resources\views/products/edit.blade.php ENDPATH**/ ?>