  ...
  <div class="space-y-6 pb-24">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mt-1">Perbarui Surat Pesanan</p>
      </div>
    ...
    <form method="POST" action="<?php echo e(route('reports.nota.update', session('nota_current_id'))); ?>" x-data="notaForm()" x-init="init()" class="space-y-6">
      <?php echo csrf_field(); ?>
      <input type="hidden" name="id" value="<?php echo e(session('nota_current_id')); ?>">
      ...
      <div class="flex gap-3 px-2">
        ...
        <button type="submit" class="flex-[2] py-5 bg-indigo-600 text-white rounded-[1.5rem] text-[11px] font-black uppercase tracking-[0.2em] shadow-xl shadow-indigo-100 active:scale-95 transition-all">Perbarui Nota</button>
      </div>
    </form>
  </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make($isMobile ? 'layouts.mobile' : 'layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SI-LARANG\resources\views/nota_pesanan/edit.blade.php ENDPATH**/ ?>