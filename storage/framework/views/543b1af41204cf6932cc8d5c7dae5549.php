...
<div class="container-fluid py-4 bts-index">
    ...
    <?php if(session('error')): ?>
        <div class="alert-error-c"><i class="fas fa-exclamation-circle"></i> <?php echo e(session('error')); ?></div>
    <?php endif; ?>
    ...
    <div class="page-header">
        <div>
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:2px;">
                <a href="<?php echo e(route('bts-towers.index')); ?>" class="btn-act btn-ghost" style="padding:6px 10px;">
                    <i class="fas fa-arrow-left"></i>
                </a>
                <h4 class="page-title">Notifikasi BTS</h4>
            </div>
            <p class="page-sub"><?php echo e($alerts->total()); ?> notifikasi &middot; <?php echo e($alerts->where('read_at', null)->count()); ?> belum dibaca</p>
        </div>
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
            <?php if($alerts->where('read_at', null)->count() > 0): ?>
                <form action="<?php echo e(route('bts-towers.alerts-read-all')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
    ...
    <div class="section-card">
        <?php $__empty_1 = true; $__currentLoopData = $alerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            ?>
            <div class="alert-card <?php echo e($isUnread ? 'unread' : ''); ?>">
                <div class="alert-icon <?php echo e($typeConfig['css']); ?>">
                    <i class="<?php echo e($typeConfig['icon']); ?>"></i>
                </div>
                ...
                <div class="alert-actions">
                    <?php if($isUnread): ?>
                        <form action="<?php echo e(route('bts-towers.alerts-read', $alert)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('bts-towers.alerts-delete', $alert)); ?>" method="POST" onsubmit="return confirm('Hapus notifikasi ini?')">
...
<?php echo $__env->make(($isMobile ?? false) ? 'layouts.mobile' : 'layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SI-LARANG\resources\views/bts-towers/alerts.blade.php ENDPATH**/ ?>