...
<div class="container-fluid py-4 bts-form-page">
    <div class="page-header">
        <div>
            ...
            <p class="page-sub"><?php echo e($btsTower->nama_bts); ?> &middot; <?php echo e($btsTower->kode_bts); ?></p>
        </div>
        <a href="<?php echo e(route('bts-towers.show', $btsTower)); ?>" class="btn-act btn-ghost">
    ...
    <form action="<?php echo e(route('bts-towers.update', $btsTower)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div style="display:flex;gap:10px;margin-top:1.25rem;">
            ...
            <a href="<?php echo e(route('bts-towers.show', $btsTower)); ?>" class="btn-act btn-ghost" style="padding:11px 28px;">
                Batal
            </a>
        </div>
    </form>
...
<?php echo $__env->make('bts-towers._map-picker-script', ['lat' => old('latitude', $btsTower->latitude), 'lng' => old('longitude', $btsTower->longitude)], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make(($isMobile ?? false) ? 'layouts.mobile' : 'layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SI-LARANG\resources\views/bts-towers/edit.blade.php ENDPATH**/ ?>