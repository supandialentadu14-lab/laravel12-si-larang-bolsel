...
<div style="border: 1.5px solid black; color: black; background: white;">
  ...
  <div style="padding: 10px 15px; border-bottom: 1.5px solid black;">
    <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
      <tr>
        ...
        <td style="padding: 2px 0;"><?php echo e($data['tahun'] ?? ''); ?></td>
      </tr>
      <tr>
        <td style="padding: 2px 0;" class="italic uppercase">KODE REKENING</td>
        <td style="padding: 2px 0;">:</td>
        <td style="padding: 2px 0;"><?php echo e($data['rekening'] ?? ''); ?></td>
      </tr>
      <tr>
        <td style="padding: 2px 0;" class="italic uppercase">NO. KWT</td>
        <td style="padding: 2px 0;">:</td>
        <td style="padding: 2px 0;"><?php echo e($data['nomor_kwt'] ?? ''); ?></td>
      </tr>
    </table>
  </div>
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 13px; line-height: 1.6;">
      <tr>
        ...
        <td style="vertical-align: top;" class="italic">
          Bendahara Pengeluaran <?php echo e(\Illuminate\Support\Str::title($data['opd_nama'] ?? ($opd->nama_opd ?? ''))); ?> Kabupaten Bolaang Mongondow Selatan
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="vertical-align: top;">:</td>
        <td style="vertical-align: top;" class="italic">
          <?php echo e($data['pembayaran_uraian'] ?? ''); ?>
  ...
  <div style="padding: 10px 15px; border-bottom: 1.5px solid black;">
    <div style="border: 1.5px solid black; width: 200px; padding: 5px 10px; display: flex; font-weight: bold; font-style: italic; font-size: 14px;">
      ...
      <span><?php echo e(number_format($data['jumlah'] ?? 0, 0, ',', '.')); ?>,-</span>
    </div>
  </div>
  ...
  <div class="signature-block" style="padding: 20px; font-size: 11px;">
    <div style="text-align: right; margin-bottom: 10px;" class="italic">
      Bolaang Uki, &nbsp;&nbsp;&nbsp; <?php echo e(\Carbon\Carbon::parse($data['tanggal'] ?? now())->translatedFormat('d F Y')); ?>
    ...
    <table style="width: 100%; border-collapse: collapse; text-align: center; table-layout: fixed; font-size: 11px;">
      ...
      <tr>
        <td class="font-bold underline">
          <?php echo e($data['pejabat']['pptk'] ?? ($nota['pptk']['nama'] ?? '')); ?>

        </td>
        <td class="font-bold underline">
          <?php echo e($data['pejabat']['bendahara'] ?? ($nota['bendahara']['nama'] ?? '')); ?>

        </td>
        <td class="font-bold underline">
          <?php echo e($data['pejabat']['pihak_ketiga'] ?? ($nota['penyedia']['pemilik'] ?? ($nota['penyedia']['toko'] ?? ''))); ?>

        </td>
      </tr>
      <tr>
        <td style="font-size: 10px;">
          NIP. <?php echo e($data['pptk_nip'] ?? ($nota['pptk']['nip'] ?? '')); ?>

        </td>
        <td style="font-size: 10px;">
          NIP. <?php echo e($data['bendahara_nip'] ?? ($nota['bendahara']['nip'] ?? '')); ?>
    ...
    <div style="text-align: center; margin-top: 15px;">
      ...
      <div class="font-bold underline">
        <?php echo e($data['pejabat']['pengguna'] ?? ($nota['ppk']['nama'] ?? '')); ?>

      </div>
      <div style="font-size: 10px;">
        NIP. <?php echo e($data['ppk_nip'] ?? ($nota['ppk']['nip'] ?? '')); ?>

      </div>
    </div>
  </div>
</div>
<?php /**PATH D:\SI-LARANG\resources\views/reports/partials/docs/kwitansi.blade.php ENDPATH**/ ?>