...
<table class="kop">
  <tr>
    <td class="kop-logo">
      <?php if(file_exists(public_path('images/bolsel.png'))): ?>
        <img src="<?php echo e(asset('images/bolsel.png')); ?>" alt="Logo Bolsel">
      <?php else: ?>
    ...
    <td class="kop-text">
      ...
      <div class="line3"><?php echo e($opd->alamat_opd ?? 'Alamat Instansi Belum Diatur'); ?></div>
    </td>
  </tr>
</table>
<div class="kop-divider"></div>
<?php /**PATH D:\SI-LARANG\resources\views/partials/kop.blade.php ENDPATH**/ ?>