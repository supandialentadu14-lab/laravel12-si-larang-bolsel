...
<div class="container-fluid py-4 bts-index">
    ...
    <div class="section-card">
        ...
        <div class="section-body">
            <form action="<?php echo e(route('bts-towers.import')); ?>" method="POST" enctype="multipart/form-data" id="importForm">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make(($isMobile ?? false) ? 'layouts.mobile' : 'layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SI-LARANG\resources\views/bts-towers/import.blade.php ENDPATH**/ ?>