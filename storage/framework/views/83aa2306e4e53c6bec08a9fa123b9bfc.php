...
<head>
    ...
    <title><?php echo e(config('app.name', 'SIMPATI')); ?></title>
            ...
            <div class="relative z-10 flex flex-col h-full">
                <div class="flex items-center lg:block">
                    <a href="/" class="flex items-center gap-2 lg:gap-3 group">
                        <img src="<?php echo e(asset('images/simpatis.png')); ?>" class="h-6 w-6 lg:h-7 lg:w-7 object-contain drop-shadow-lg" alt="Logo">
                ...
                <div class="mt-auto mb-auto lg:block hidden">
                    <div class="relative group">
                        ...
                        <div class="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-[1.8rem] p-2.5 overflow-hidden shadow-2xl">
                            <img src="<?php echo e(asset('images/login-bg-neww.png')); ?>" class="w-full h-auto rounded-[1.2rem] transform group-hover:scale-105 transition duration-700" alt="Dashboard Preview" loading="lazy">
                        </div>
                    </div>
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                <div class="w-full max-w-[320px] mx-auto overflow-y-auto no-scrollbar py-2 px-1">
                    ...
                    <div class="mb-3 text-center lg:text-left">
                        <h2 class="text-2xl lg:text-3xl font-black text-slate-900 mb-1 uppercase tracking-tight leading-none"><?php echo e($title); ?></h2>
                        <?php if($subtitle): ?>
                        <p class="text-slate-400 font-medium text-[9px] lg:text-[11px] mt-1.5 uppercase tracking-widest leading-relaxed"><?php echo e($subtitle); ?></p>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                ...
                <div class="mt-1 text-center space-y-1.5 border-t border-slate-100 pt-3 pb-1">
                    <?php if(Request::routeIs('login')): ?>
                        <p class="text-[9px] font-bold text-slate-400 uppercase tracking-wider">
                            Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="font-black text-indigo-600 hover:text-indigo-800 ml-1">Daftar</a>
                        </p>
                    <?php elseif(Request::routeIs('register')): ?>
                        <p class="text-[9px] font-bold text-slate-400 uppercase tracking-wider">
                            Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="font-black text-indigo-600 hover:text-indigo-800 ml-1">Login</a>
                        </p>
                    <?php endif; ?>
                    <div>
...
<?php /**PATH D:\SI-LARANG\resources\views/components/guest-layout.blade.php ENDPATH**/ ?>