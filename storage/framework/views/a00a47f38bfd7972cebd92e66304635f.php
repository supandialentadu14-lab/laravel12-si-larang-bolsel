...
<div style="display: flex; justify-content: space-between; margin-bottom: 20px; line-height: 1.3;">
  <div style="flex: 1;">
    <table style="border: none !important; border-collapse: collapse; width: 100%;">
      <tr style="border: none;">
        ...
        <td style="border: none; padding: 2px 0; font-size: 14px;" class="font-bold"><?php echo e($data['nomor']); ?></td>
      </tr>
      <tr style="border: none;">
      ...
      <tr style="border: none;">
        ...
        <td style="border: none; vertical-align: top; padding: 2px 0; font-size: 14px;" class="font-bold">
          Belanja <?php echo e($data['belanja']); ?> Pada Keg. <?php echo e($data['kegiatan']); ?> <br>
          Sub Keg. <?php echo e($data['sub_kegiatan']); ?> Tahun <?php echo e($data['tahun']); ?>
  ...
  <div style="width: 250px; padding-left: 60px; font-size: 14px;">
    <p style="margin: 0 0 16px 0;">Bolaang Uki, <?php echo e(\Carbon\Carbon::parse($data['tanggal'])->translatedFormat('d F Y')); ?></p>
    <p style="margin: 0;">Kepada Yth.</p>
    <p style="margin: 0;" class="font-bold"><?php echo e($data['penyedia']['toko'] ?? ''); ?></p>
...
<p>Dengan hormat,</p>
<p>Untuk keperluan pengadaan <?php echo e($data['belanja']); ?> dalam Kegiatan <?php echo e($data['kegiatan']); ?>, Sub Kegiatan <?php echo e($data['sub_kegiatan']); ?> pada Tahun <?php echo e($data['tahun']); ?>, harap dapat diberikan barang/bahan di bawah ini:</p>
<?php else: ?>
  <div class="text-center mb-4">
    <h2 class="font-bold uppercase" style="font-size: 14px; text-decoration: underline;">SAMBUNGAN NOTA PESANAN - <?php echo e($data['nomor']); ?></h2>
  </div>
<?php endif; ?>
...
<table class="report-table" style="table-layout: fixed; width: 100%;">
  <thead>
    <tr class="text-center font-bold" style="background-color: #f8fafc;">
      ...
      <th style="width:100px; font-size:12px;">Kuantitas</th>
  ...
  <tbody>
    <?php $grand = 0; ?>
    <?php $__currentLoopData = $data['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php $grand += $row['total']; ?>
      <tr>
        <td class="text-center"><?php echo e($i + 1); ?></td>
        <td><?php echo e($row['name']); ?></td>
        <td class="text-center"><?php echo e($row['qty']); ?></td>
        <td class="text-center"><?php echo e($row['unit']); ?></td>
        <td class="text-right">
          <div style="display: flex; justify-content: space-between;">
            <span>Rp</span>
            <span><?php echo e(number_format($row['price'] ?? 0, 0, ',', '.')); ?></span>
          </div>
        </td>
        <td class="text-right font-bold">
          <div style="display: flex; justify-content: space-between;">
            <span>Rp</span>
            <span><?php echo e(number_format($row['total'] ?? 0, 0, ',', '.')); ?></span>
          </div>
        </td>
      </tr>
    ...
    <tr style="background-color: #f8fafc;">
      ...
      <td class="text-right font-bold">
        <div style="display: flex; justify-content: space-between;">
          <span>Rp</span>
          <span><?php echo e(number_format($grand, 0, ',', '.')); ?></span>
        </div>
      </td>
    </tr>
  </tbody>
...
<table style="width: 100%; border: none; border-collapse: collapse; margin-bottom: 10px;">
  <tr>
    ...
    <td style="text-align: justify; padding-left: 6px; border: none; font-size: 14px;">
      Pembayaran melalui bendahara pengeluaran <?php echo e(\Illuminate\Support\Str::title($opd->nama_opd ?? '')); ?>.
    </td>
  </tr>
  <tr>
...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px; margin-top: 10px; text-align: center; font-size: 12px; line-height: 1.25;" class="signature-block">
  <div>
    <p style="margin: 2px 0;">&nbsp;</p>
    <p style="margin: 2px 0;">Setuju Untuk Melaksanakan Pekerjaan</p>
    <div style="height: 55px;"></div>
    <p class="font-bold underline" style="margin: 2px 0;"><?php echo e($data['penyedia']['pemilik'] ?? ''); ?></p>
  </div>
  <div>
    <p style="margin: 2px 0;">Bolaang Uki, <?php echo e(\Carbon\Carbon::parse($data['tanggal'])->translatedFormat('d F Y')); ?></p>
    <p style="margin: 2px 0;">Pejabat Pengadaan</p>
    <div style="height: 55px;"></div>
    <p class="font-bold underline" style="margin: 2px 0;"><?php echo e($data['pejabat']['nama'] ?? ''); ?></p>
    <p style="margin: 2px 0;">NIP. <?php echo e($data['pejabat']['nip'] ?? '-'); ?></p>
  </div>
</div>

<div class="text-center signature-block" style="margin-top: 15px; font-size: 12px; line-height: 1.25;">
  <p style="margin: 2px 0;">Mengetahui,</p>
  <p style="margin: 2px 0;">Pengguna Anggaran Selaku PPK</p>
  <div style="height: 55px;"></div>
  <p class="font-bold underline" style="margin: 2px 0;"><?php echo e($data['ppk']['nama'] ?? ''); ?></p>
  <p style="margin: 2px 0;">NIP. <?php echo e($data['ppk']['nip'] ?? '-'); ?></p>
</div>
</div>
<?php endif; ?>
<?php /**PATH D:\SI-LARANG\resources\views/reports/partials/docs/nota_pesanan.blade.php ENDPATH**/ ?>