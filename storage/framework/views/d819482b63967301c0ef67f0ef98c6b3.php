      ...
      <div class="grid grid-cols-1 gap-6">
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-1.5">
              ...
              <textarea x-ref="pp_jabatan" name="pihak_pertama[jabatan]" rows="2" 
                ...
                oninput="this.setCustomValidity('')"
                class="w-full bg-white/10 border-none rounded-xl px-4 py-3 text-xs font-bold placeholder:text-white/40 outline-none leading-snug" required><?php echo e($data['pihak_pertama']['jabatan'] ?? ''); ?></textarea>
            </div>
          </div>
        </div>
        ...
        <div class="bg-rose-600 rounded-[2.5rem] p-6 text-white shadow-xl shadow-rose-100 space-y-6">
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-1.5">
              <label class="text-[8px] font-black uppercase tracking-widest opacity-60 ml-2">NIP</label>
              <input type="text" name="pihak_kedua[nip]" value="<?php echo e($data['pihak_kedua']['nip'] ?? ''); ?>" placeholder="NIP / Identitas" 
            ...
            <div class="space-y-1.5">
              ...
              <textarea name="pihak_kedua[jabatan]" rows="2" 
                ...
                oninput="this.setCustomValidity('')"
                class="w-full bg-white/10 border-none rounded-xl px-4 py-3 text-xs font-bold placeholder:text-white/40 outline-none leading-snug" required><?php echo e($data['pihak_kedua']['jabatan'] ?? ''); ?></textarea>
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make($isMobile ? 'layouts.mobile' : 'layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SI-LARANG\resources\views/pinjam_pakai/edit.blade.php ENDPATH**/ ?>