...
<div class="container-fluid py-4 bts-show">
        ...
        <div class="hero-top">
            <div>
                <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;flex-wrap:wrap;">
                    <span class="hero-badge <?php echo e(strtolower(str_replace(' ', '-', $btsTower->status_operasional ?? 'aktif'))); ?>">
                        <i class="fas fa-signal"></i> <?php echo e($btsTower->status_operasional ?? 'Aktif'); ?>

                    </span>
                    <?php if($btsTower->kondisi): ?>
                        <span style="font-size:10px;color:#6b7280;font-weight:600;">
                            Kondisi: <span style="color:<?php echo e($btsTower->kondisi === 'Baik' ? '#34d399' : ($btsTower->kondisi === 'Rusak Berat' ? '#f87171' : '#fbbf24')); ?>"><?php echo e($btsTower->kondisi); ?></span>
                        </span>
                    <?php endif; ?>
                </div>
                <h4 class="hero-title"><?php echo e($btsTower->nama_bts); ?></h4>
                <p class="hero-sub"><span><?php echo e($btsTower->kode_bts); ?></span> &middot; <?php echo e($btsTower->provider); ?></p>
            </div>
        </div>
        ...
        <div class="stats-row">
            <div class="stat-pill">
                ...
                <div>
                    ...
                    <div class="stat-value"><?php echo e($btsTower->kecamatan); ?></div>
                </div>
            </div>
            <div class="stat-pill">
                ...
                <div>
                    ...
                    <div class="stat-value"><?php echo e($btsTower->tipe_tower ?: '-'); ?></div>
                </div>
            </div>
            <div class="stat-pill">
                ...
                <div>
                    ...
                    <div class="stat-value"><?php echo e($btsTower->tinggi_tower ? $btsTower->tinggi_tower . ' m' : '-'); ?></div>
                </div>
            </div>
            <div class="stat-pill">
                ...
                <div>
                    ...
                    <div class="stat-value"><?php echo e($btsTower->tahun_dibangun ?: '-'); ?></div>
                </div>
            </div>
        </div>

        <div class="hero-actions">
            <a href="<?php echo e(route('bts-towers.report', $btsTower)); ?>" target="_blank" class="btn-act btn-indigo">
                <i class="fas fa-file-pdf"></i> Laporan PDF
            </a>
            <a href="<?php echo e(route('bts-towers.edit', $btsTower)); ?>" class="btn-act btn-amber">
                <i class="fas fa-pen"></i> Edit
            </a>
            <form action="<?php echo e(route('bts-towers.toggle-status', $btsTower)); ?>" method="POST" style="display:inline;">
                <?php echo csrf_field(); ?>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if($allPhotos->count() > 0): ?>
                        <div class="photo-slider" id="photoSlider">
                            <div class="photo-slider-track" id="sliderTrack">
                                <?php $__currentLoopData = $allPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="photo-slider-slide">
                                        <img src="<?php echo e($p->url); ?>" alt="<?php echo e($p->caption ?? $btsTower->nama_bts); ?>">
                                        <?php if($p->caption): ?>
                                            <div class="photo-slider-caption"><?php echo e($p->caption); ?></div>
                                        <?php endif; ?>
                                        <?php if($p->id): ?>
                                            <form action="<?php echo e(route('bts-towers.delete-photo', $p)); ?>" method="POST" onsubmit="return confirm('Hapus foto ini?')">
                            ...
                            <?php if($allPhotos->count() > 1): ?>
                                ...
                                <div class="photo-slider-dots" id="sliderDots">
                                    <?php $__currentLoopData = $allPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" class="photo-slider-dot <?php echo e($idx === 0 ? 'active' : ''); ?>" onclick="goToSlide(<?php echo e($idx); ?>)"></button>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php endif; ?>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="detail-tbl">
                        <tr><th>Kode BTS</th><td><?php echo e($btsTower->kode_bts); ?></td></tr>
                        <tr><th>Provider</th><td>
                            <span style="display:inline-flex;align-items:center;gap:6px;">
                                <span style="width:8px;height:8px;border-radius:50%;background:<?php echo e($providerColors[$btsTower->provider] ?? '#95a5a6'); ?>;"></span>
                                <?php echo e($btsTower->provider); ?>

                            </span>
                        </td></tr>
                        <tr><th>Nama Perusahaan</th><td><?php echo e($btsTower->nama_perusahaan ?: '-'); ?></td></tr>
                        <tr><th>Kecamatan</th><td><?php echo e($btsTower->kecamatan); ?></td></tr>
                        <tr><th>Desa / Kelurahan</th><td><?php echo e($btsTower->desa ?: '-'); ?></td></tr>
                        <tr><th>Alamat Lengkap</th><td><?php echo e($btsTower->alamat ?: '-'); ?></td></tr>
                        <tr><th>Koordinat</th><td>
                            <span style="font-family:monospace;font-size:12px;"><?php echo e($btsTower->latitude); ?>, <?php echo e($btsTower->longitude); ?></span>
                            <a href="https://www.google.com/maps?q=<?php echo e($btsTower->latitude); ?>,<?php echo e($btsTower->longitude); ?>" target="_blank" style="font-size:10px;color:#818cf8;margin-left:6px;text-decoration:none;">
                                <i class="fas fa-external-link-alt"></i>
                            </a>
                        </td></tr>
                        <tr><th>Tinggi Tower</th><td><?php echo e($btsTower->tinggi_tower ? $btsTower->tinggi_tower . ' meter' : '-'); ?></td></tr>
                        <tr><th>Tipe Tower</th><td><?php echo e($btsTower->tipe_tower ?: '-'); ?></td></tr>
                        <tr><th>Tahun Dibangun</th><td><?php echo e($btsTower->tahun_dibangun ?: '-'); ?></td></tr>
                        <tr><th>Kondisi Fisik</th><td>
                            <?php if($btsTower->kondisi): ?>
                                <span style="display:inline-flex;padding:3px 10px;border-radius:6px;font-size:11px;font-weight:700;
                                    background:<?php echo e($btsTower->kondisi === 'Baik' ? 'rgba(16,185,129,0.12)' : ($btsTower->kondisi === 'Rusak Berat' ? 'rgba(239,68,68,0.12)' : 'rgba(245,158,11,0.12)')); ?>;
                                    color:<?php echo e($btsTower->kondisi === 'Baik' ? '#34d399' : ($btsTower->kondisi === 'Rusak Berat' ? '#f87171' : '#fbbf24')); ?>;">
                                    <?php echo e($btsTower->kondisi); ?>
                        ...
                        <tr><th>Status Operasional</th><td>
                            <?php if($btsTower->status_operasional): ?>
                                <span style="display:inline-flex;padding:3px 10px;border-radius:6px;font-size:11px;font-weight:700;
                                    background:<?php echo e($btsTower->status_operasional === 'Aktif' ? 'rgba(16,185,129,0.12)' : ($btsTower->status_operasional === 'Maintenance' ? 'rgba(245,158,11,0.12)' : 'rgba(156,163,175,0.12)')); ?>;
                                    color:<?php echo e($btsTower->status_operasional === 'Aktif' ? '#34d399' : ($btsTower->status_operasional === 'Maintenance' ? '#fbbf24' : '#9ca3af')); ?>;">
                                    <?php echo e($btsTower->status_operasional); ?>

                                </span>
                            <?php else: ?> -
                            <?php endif; ?>
                        </td></tr>
                        <tr><th>Keterangan</th><td><?php echo e($btsTower->keterangan ?: '-'); ?></td></tr>
                        <tr><th>Radius Cakupan</th><td>
                            <?php if($btsTower->coverage_radius): ?>
                                <span style="color:#818cf8;font-weight:700;"><?php echo e($btsTower->coverage_radius); ?> km</span>
                            <?php else: ?> <span style="color:#4b5563;">-</span> <?php endif; ?>
                        </td></tr>
                        <tr><th>Dibuat</th><td style="font-size:11px;color:#6b7280;"><?php echo e($btsTower->created_at?->translatedFormat('d M Y, H:i')); ?></td></tr>
                    </table>
                </div>
            </div>
        </div>
    ...
    <div class="tab-panel" id="tab-catatan">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $btsTower->notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="note-card">
                <div class="note-header">
                    <div>
                        <span class="note-type-badge <?php echo e($note->type); ?>"><?php echo e(ucfirst($note->type)); ?></span>
                        <span class="note-title" style="margin-left:8px;"><?php echo e($note->judul); ?></span>
                    </div>
                    <form action="<?php echo e(route('bts-towers.destroy-note', $note)); ?>" method="POST" onsubmit="return confirm('Hapus catatan ini?')">
                        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                ...
                <div class="note-meta">
                    <?php echo e($note->tanggal?->translatedFormat('d M Y')); ?> &middot; Oleh: <?php echo e($note->user?->name ?? 'Sistem'); ?>

                    <?php if($note->teknisi): ?> &middot; Teknisi: <?php echo e($note->teknisi); ?> <?php endif; ?>
                    <?php if($note->biaya): ?> &middot; Biaya: Rp <?php echo e(number_format((float) str_replace(['.',' ',','], '', $note->biaya), 0, ',', '.')); ?> <?php endif; ?>
                </div>
                <div class="note-body"><?php echo e($note->isi); ?></div>
            </div>
    ...
    <div class="tab-panel" id="tab-terdekat">
        <div class="card">
            ...
            <div class="card-body">
                <?php $__empty_1 = true; $__currentLoopData = $nearbyTowers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $near): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="nearby-row">
                        <span class="nearby-dot" style="background:<?php echo e($providerColors[$near->provider] ?? '#95a5a6'); ?>;"></span>
                        <div class="nearby-info">
                            <div class="nearby-name"><?php echo e($near->nama_bts); ?></div>
                            <div class="nearby-sub"><?php echo e($near->provider); ?> &middot; <?php echo e($near->kecamatan); ?> &middot; <?php echo e($near->status_operasional ?? 'N/A'); ?></div>
                        </div>
                        <div class="nearby-dist"><?php echo e(number_format($near->distance, 1)); ?> km</div>
                        <a href="<?php echo e(route('bts-towers.show', $near)); ?>" style="color:#818cf8;font-size:12px;text-decoration:none;margin-left:8px;">
...
<div id="addPhotoModal" style="display:none;position:fixed;inset:0;z-index:9999;align-items:center;justify-content:center;background:rgba(0,0,0,0.6);backdrop-filter:blur(4px);" onclick="if(event.target===this)this.style.display='none'">
    <div style="background:#131825;border:1px solid #232b4a;border-radius:16px;color:#e5e7eb;width:90%;max-width:540px;max-height:90vh;overflow-y:auto;">
        <form action="<?php echo e(route('bts-towers.add-photos', $btsTower)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<div id="addNoteModal" style="display:none;position:fixed;inset:0;z-index:9999;align-items:center;justify-content:center;background:rgba(0,0,0,0.6);backdrop-filter:blur(4px);" onclick="if(event.target===this)this.style.display='none'">
    <div style="background:#131825;border:1px solid #232b4a;border-radius:16px;color:#e5e7eb;width:90%;max-width:640px;max-height:90vh;overflow-y:auto;">
            <form action="<?php echo e(route('bts-towers.add-note', $btsTower)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div style="padding:16px 20px;border-bottom:1px solid #232b4a;display:flex;justify-content:space-between;align-items:center;">
                ...
                <div style="padding:20px;">
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px;">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal" value="<?php echo e(now()->toDateString()); ?>" style="width:100%;height:38px;background:#1a2035;border:1px solid #2a3252;color:#e5e7eb;border-radius:10px;padding:0 12px;font-size:13px;">
                        </div>
                    </div>
                    <div style="margin-bottom:12px;">
...
<script>
    ...
    const lat = <?php echo e($btsTower->latitude); ?>;
    const lng = <?php echo e($btsTower->longitude); ?>;
    const towerName = <?php echo json_encode($btsTower->nama_bts, 15, 512) ?>;
    const provider = <?php echo json_encode($btsTower->provider, 15, 512) ?>;
    const providerColors = <?php echo json_encode($providerColors, 15, 512) ?>;
    ...
    function initDetailMap() {
        ...
        const coverageRadius = <?php echo e($btsTower->coverage_radius ?? 'null'); ?>;
        ...
        const nearby = <?php echo json_encode($nearbyTowers, 15, 512) ?>;
        nearby.forEach(t => {
...
<?php echo $__env->make(($isMobile ?? false) ? 'layouts.mobile' : 'layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SI-LARANG\resources\views/bts-towers/show.blade.php ENDPATH**/ ?>