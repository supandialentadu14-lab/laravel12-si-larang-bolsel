...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Laporan'); ?> - SIMPATI</title>
    ...
    <style>
        ...
        @media print {
            ...
            * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
            ...
            @page {
                size: <?php echo $__env->yieldContent('report_size', '215mm 330mm portrait'); ?>;
                margin: 0;
            }
            ...
            html, body {
                ...
                margin: 0 !important;
                padding: 0 !important;
                width: <?php echo $__env->yieldContent('report_width', '215mm'); ?> !important;
            }
...
<body class="<?php echo $__env->yieldContent('report_class'); ?>">
    <div class="preview-workspace">
        
        <div class="document-area" id="doc-scroller">
            <div id="paper-stack">
                <div class="report-paper <?php echo $__env->yieldContent('report_class'); ?>" id="initial-page">
                    <?php echo $__env->yieldContent('report_content'); ?>
                </div>
            </div>
        </div>
        ...
        <div class="sidebar no-print">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="p-3 bg-white rounded-xl border border-slate-200 shadow-sm">
                    <?php echo $__env->yieldContent('extra_buttons'); ?>
                </div>
                ...
                <a href="<?php echo $__env->yieldContent('back_url', route('dashboard')); ?>" 
...
<?php /**PATH D:\SI-LARANG\resources\views/layouts/report_print.blade.php ENDPATH**/ ?>