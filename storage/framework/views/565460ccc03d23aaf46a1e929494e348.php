...
<head>
  ...
  <?php if(file_exists(public_path('build/manifest.json')) || file_exists(public_path('hot'))): ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/desktop.css', 'resources/js/desktop.js']); ?>
  <?php else: ?>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      var collapse = <?php echo json_encode(session('collapse_submenus') ? true : false); ?>;
      if (collapse) {
        try {
  ...
  <div class="flex flex-row flex-1 min-h-0 overflow-hidden">
    ...
    <aside id="sidebar-main" 
      ...
      <div class="p-8">
        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3">
          <div class="w-10 h-10 rounded-xl bg-indigo-600 flex items-center justify-center shadow-lg shadow-indigo-500/20">
            <img src="<?php echo e(asset('images/simpatis.png')); ?>" class="w-8 h-8 object-contain" onerror="this.src='https://ui-avatars.com/api/?name=S&background=4F46E5&color=ffffff'">
          </div>
      ...
      <nav x-data="{ 
        activeMenu: '<?php echo e(request()->is('products*') || request()->is('categories*') || request()->is('suppliers*') || request()->is('import/products*') ? 'master' : (request()->is('stock*') || request()->is('reports*') ? 'transaksi' : (request()->is('settings*') || request()->routeIs('users.*') || request()->routeIs('activity_log.*') || request()->routeIs('backups.*') ? 'manajemen' : 'none'))); ?>' 
        ...
        <div class="pb-4">
          <button @click="activeMenu = (activeMenu === 'bts' ? 'none' : 'bts')" 
                  ...
                  :class="activeMenu === 'bts' || <?php echo e(json_encode(request()->routeIs('bts-towers.*'))); ?> ? 'active' : ''">
          ...
          <div x-show="activeMenu === 'bts'" x-transition class="mt-1 space-y-1">
            <a href="<?php echo e(route('bts-towers.index')); ?>" class="sub-link <?php echo e(request()->routeIs('bts-towers.index') ? 'active' : ''); ?>">Data & Peta</a>
            <a href="<?php echo e(route('bts-towers.import-form')); ?>" class="sub-link <?php echo e(request()->routeIs('bts-towers.import*') ? 'active' : ''); ?>">Import Data</a>
            <a href="<?php echo e(route('bts-towers.report-all')); ?>" target="_blank" class="sub-link">Laporan Kab.</a>
            <a href="<?php echo e(route('bts-towers.alerts')); ?>" class="sub-link <?php echo e(request()->routeIs('bts-towers.alerts') ? 'active' : ''); ?>">Notifikasi</a>
          </div>
        </div>
        ...
        <div class="pb-4">
          <button @click="activeMenu = (activeMenu === 'master' ? 'none' : 'master')" 
                  class="sidebar-link w-full"
                  :class="activeMenu === 'master' || <?php echo e(json_encode(request()->is('products*') || request()->is('categories*') || request()->is('suppliers*') || request()->is('import/products*'))); ?> ? 'active' : ''">
          ...
          <div x-show="activeMenu === 'master'" x-transition class="mt-1 space-y-1">
            <a href="<?php echo e(route('categories.index')); ?>" class="sub-link <?php echo e(request()->routeIs('categories.*') ? 'active' : ''); ?>">Jenis Belanja</a>
            <a href="<?php echo e(route('suppliers.index')); ?>" class="sub-link <?php echo e(request()->routeIs('suppliers.*') ? 'active' : ''); ?>">Penyedia</a>
            <a href="<?php echo e(route('products.index')); ?>" class="sub-link <?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>">Data Barang</a>
          </div>
        </div>
        ...
        <div class="pb-4">
          <button @click="activeMenu = (activeMenu === 'transaksi' ? 'none' : 'transaksi')" 
                  class="sidebar-link w-full"
                  :class="activeMenu === 'transaksi' || <?php echo e(json_encode(request()->is('stock*') || request()->is('reports*'))); ?> ? 'active' : ''">
          ...
          <div x-show="activeMenu === 'transaksi'" x-transition class="mt-1 space-y-1">
            <a href="<?php echo e(route('stock.index')); ?>" class="sub-link <?php echo e(request()->routeIs('stock.index') ? 'active' : ''); ?>">Mutasi Masuk/Keluar</a>
            <a href="<?php echo e(route('reports.belanja.modal.list')); ?>" class="sub-link <?php echo e(request()->routeIs('reports.belanja.modal.list') ? 'active' : ''); ?>">Daftar Belanja</a>
            <a href="<?php echo e(route('reports.nota.list')); ?>" class="sub-link <?php echo e(request()->routeIs('reports.nota.list') ? 'active' : ''); ?>">Nota Pesanan</a>
            <a href="<?php echo e(route('reports.pemeriksaan.list')); ?>" class="sub-link <?php echo e(request()->routeIs('reports.pemeriksaan.list') ? 'active' : ''); ?>">Pemeriksaan</a>
            <a href="<?php echo e(route('reports.penerimaan.list')); ?>" class="sub-link <?php echo e(request()->routeIs('reports.penerimaan.list') ? 'active' : ''); ?>">Penerimaan (BASTB)</a>
            <a href="<?php echo e(route('reports.kwitansi.list')); ?>" class="sub-link <?php echo e(request()->routeIs('reports.kwitansi.list') ? 'active' : ''); ?>">Kwitansi</a>
            <a href="<?php echo e(route('reports.opname.list')); ?>" class="sub-link <?php echo e(request()->routeIs('reports.opname.list') ? 'active' : ''); ?>">BA Opname</a>
            <a href="<?php echo e(route('reports.pinjam.list')); ?>" class="sub-link <?php echo e(request()->routeIs('reports.pinjam.list') ? 'active' : ''); ?>">Pinjam Pakai</a>
            <div class="mx-3 my-2 h-px bg-slate-700/50"></div>
            <a href="<?php echo e(route('agenda.surat.index')); ?>" class="sub-link <?php echo e(request()->routeIs('agenda.surat.*') ? 'active' : ''); ?>">
        ...
        <div class="pb-4">
          <button @click="activeMenu = (activeMenu === 'manajemen' ? 'none' : 'manajemen')" 
                  class="sidebar-link w-full"
                  :class="activeMenu === 'manajemen' || <?php echo e(json_encode(request()->is('settings*') || request()->routeIs('users.*') || request()->routeIs('activity_log.*'))); ?> ? 'active' : ''">
          ...
          <div x-show="activeMenu === 'manajemen'" x-transition class="mt-1 space-y-1">
            <a href="<?php echo e(route('settings.opd.index')); ?>" class="sub-link <?php echo e(request()->routeIs('settings.opd.index') ? 'active' : ''); ?>">Instansi (OPD)</a>
            <?php if(Auth::user()->isAdmin()): ?>
              <a href="<?php echo e(route('users.index')); ?>" class="sub-link <?php echo e(request()->routeIs('users.*') ? 'active' : ''); ?>">Pengguna</a>
              <a href="<?php echo e(route('activity_log.index')); ?>" class="sub-link <?php echo e(request()->routeIs('activity_log.*') ? 'active' : ''); ?>">Log Aktivitas</a>
              <a href="<?php echo e(route('backups.index')); ?>" class="sub-link <?php echo e(request()->routeIs('backups.*') ? 'active' : ''); ?>">Cadangan Data</a>
            <?php endif; ?>
          </div>
        </div>
        ...
        <div class="pb-4">
          <a href="<?php echo e(route('profile.edit')); ?>" 
             @click="activeMenu = 'none'"
             class="sidebar-link <?php echo e(request()->routeIs('profile.edit') ? 'active' : ''); ?>">
    ...
    <div id="desktop-content-wrapper" class="flex-1 flex flex-col min-w-0 bg-app-bg relative transition-all duration-300 ease-in-out">
      ...
      <header class="h-20 sticky top-0 bg-app-surface/80 backdrop-blur-md border-b border-app-main flex items-center justify-between px-4 lg:px-8 no-print z-20 transition-colors duration-300">
        ...
        <div class="flex items-center gap-4 pl-10 border-l border-app-main">
          ...
          <!-- Chat -->
          <a href="<?php echo e(route('chat.index')); ?>" class="w-11 h-11 rounded-xl bg-app-surface border border-app-main flex items-center justify-center text-app-muted hover:text-indigo-600 transition relative shadow-sm">
          ...
          <div class="w-10 h-10 rounded-xl bg-indigo-600 overflow-hidden border border-indigo-500 shadow-sm flex-shrink-0 p-0.5">
            <img id="top-profile-img" class="w-full h-full rounded-[10px] object-cover" src="<?php echo e(Auth::user()->avatar ? asset('media/' . Auth::user()->avatar . '?v=' . (Auth::user()->avatar_updated_at?->timestamp ?? time())) : 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name) . '&background=4F46E5&color=ffffff'); ?>">
          </div>
        </div>
      </header>
      ...
      <div id="main-content-wrapper" class="flex-1 overflow-y-auto custom-scrollbar px-4 lg:px-8 py-6 lg:py-10 bg-app-bg">
        <div id="content-container-fade" class="content-area-fade">
          ...
          <div class="flex items-center justify-between mb-2 no-print">
            <div id="page-header">
              <h1 class="text-[2.2rem] font-black text-app-main tracking-tight leading-none transition-colors duration-300"><?php echo $__env->yieldContent('header'); ?></h1>
              <p class="text-[10px] font-extrabold text-app-muted uppercase tracking-[0.3em] mt-3 transition-colors duration-300"><?php echo $__env->yieldContent('subheader'); ?></p>
            </div>
          ...
          <?php if(session('success')): ?>
            <div class="mb-8 p-6 bg-emerald-50 border border-emerald-100 rounded-[2rem] flex items-center gap-4 text-emerald-800 animate-fadeIn">
              ...
              <div class="flex-1">
                ...
                <p class="text-xs opacity-80"><?php echo e(session('success')); ?></p>
              </div>
            </div>
          <?php endif; ?>
          ...
          <?php if(session('error') || $errors->any()): ?>
            <div class="mb-8 p-6 bg-rose-50 border border-rose-100 rounded-[2rem] flex items-center gap-4 text-rose-800 animate-fadeIn">
              ...
              <div class="flex-1">
                ...
                <p class="text-xs opacity-80"><?php echo e(session('error') ?? 'Silakan periksa inputan Anda.'); ?></p>
              </div>
            </div>
          <?php endif; ?>
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center justify-between gap-2">
                      <h3 class="text-[10px] font-black text-white truncate uppercase"><?php echo e($item->name); ?></h3>
                      <span class="px-1.5 py-0.5 bg-white text-rose-500 text-[8px] font-black rounded-md"><?php echo e($item->stock); ?></span>
                    </div>
                    <p class="text-[9px] font-bold text-white/70 mt-0.5 lowercase"><?php echo e($item->unit); ?> tersisa</p>
                  </div>
                </div>
              </div>
...
<?php /**PATH D:\SI-LARANG\resources\views/layouts/admin.blade.php ENDPATH**/ ?>