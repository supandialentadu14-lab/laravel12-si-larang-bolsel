<?php if($is_first ?? true): ?>
  ...
  <div class="text-center mb-3" style="margin-top: 6px;">
    <h2 class="text-center font-bold underline uppercase" style="font-size: 15px;">BERITA ACARA PEMERIKSAAN
      BARANG/PEKERJAAN</h2>
    <p class="text-center" style="margin-top: 1px;">NOMOR: <?php echo e($data['nomor'] ?? '-'); ?></p>
  </div>

  <p>
    <?php echo e($data['tanggal_kata'] ?? ('Pada hari ' . \Carbon\Carbon::parse($data['tanggal'])->locale('id')->translatedFormat('l') . ' tanggal ' . \Carbon\Carbon::parse($data['tanggal'])->translatedFormat('d F Y'))); ?>,
  ...
  <table style="border: none !important; width: 100%; margin: 6px 0; line-height: 1.2;">
    <tr style="border: none;">
      ...
      <td style="border: none; padding: 1px 0;"><span class="font-bold"><?php echo e($data['ppk']['nama'] ?? ''); ?></span></td>
    </tr>
    <tr style="border: none;">
    ...
    <tr style="border: none;">
      ...
      <td style="border: none; padding: 1px 0;">:</td>
      <td style="border: none; padding: 1px 0;"><?php echo e($data['ppk']['alamat'] ?? ''); ?></td>
    </tr>
  </table>

  <p>Menerangkan dengan benar bahwa Pihak Pertama telah menyerahkan pekerjaan : <span
      class="font-bold"><?php echo e($data['nota']['belanja'] ?? ''); ?></span></p>

  <table style="border: none !important; width: 100%; margin: 6px 0; line-height: 1.2;">
    <tr style="border: none;">
      <td style="border: none; width: 150px; padding: 1px 0;">Nama Penyedia Jasa</td>
      <td style="border: none; width: 15px; padding: 1px 0;">:</td>
      <td style="border: none; padding: 1px 0;" class="font-bold"><?php echo e($data['nota']['penyedia']['toko'] ?? ''); ?></td>
    </tr>
    <tr style="border: none;">
  ...
  <p>Sebagai realisasi Nota Pesanan Nomor : <?php echo e($data['nota']['nomor'] ?? '-'); ?> tanggal
    <?php echo e(\Carbon\Carbon::parse($data['nota']['tanggal'] ?? now())->locale('id')->translatedFormat('d F Y')); ?>, dengan
  ...
  <tbody>
      ...
      <tr>
        ...
        <td class="text-right">
          <div style="display: flex; justify-content: space-between;">
            <span>Rp</span>
            <span><?php echo e(number_format($item['harga'] ?? 0, 0, ',', '.')); ?></span>
          </div>
        </td>
        <td class="text-right font-bold">
          <div style="display: flex; justify-content: space-between;">
            <span>Rp</span>
            <span><?php echo e(number_format($item['jumlah'] ?? 0, 0, ',', '.')); ?></span>
          </div>
        </td>
      </tr>
    ...
    <tr>
      <td colspan="6" class="text-center font-bold italic" style="padding: 10px;">Terbilang :
        <?php echo e($data['terbilang'] ?? ''); ?> rupiah</td>
    </tr>
  </tbody>
</table>
    ...
    <div
      ...
      <div>
        ...
        <div class="font-bold underline">
          <?php echo e($data['nota']['penyedia']['pemilik'] ?? ($data['nota']['penyedia']['toko'] ?? '')); ?></div>
      </div>
      <div>
        <div>Bolaang Uki, <?php echo e(\Carbon\Carbon::parse($data['tanggal'])->translatedFormat('d F Y')); ?></div>
...
<?php endif; ?><?php /**PATH D:\SI-LARANG\resources\views/reports/partials/docs/pemeriksaan.blade.php ENDPATH**/ ?>