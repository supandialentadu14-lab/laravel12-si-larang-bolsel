...
<div class="container-fluid py-4 bts-index">
    ...
    <?php if(session('success')): ?>
        <div class="alert-success-c"><i class="fas fa-check-circle"></i> <?php echo e(session('success')); ?></div>
    <?php endif; ?>
    ...
    <div class="page-header">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
            <a href="<?php echo e(route('bts-towers.report-all', request()->query())); ?>" target="_blank" class="btn-act btn-purple">
                <i class="fas fa-file-pdf"></i> Laporan Kab.
            </a>
            <a href="<?php echo e(route('bts-towers.export-excel', request()->query())); ?>" class="btn-act btn-green">
                <i class="fas fa-file-csv"></i> CSV
            </a>
            <a href="<?php echo e(route('bts-towers.export-geojson', request()->query())); ?>" class="btn-act btn-ghost" style="color:#60a5fa;border-color:rgba(96,165,250,0.2);">
                <i class="fas fa-globe"></i> GeoJSON
            </a>
            <a href="<?php echo e(route('bts-towers.export-kml', request()->query())); ?>" class="btn-act btn-ghost" style="color:#f472b6;border-color:rgba(244,114,182,0.2);">
                <i class="fas fa-map-marked-alt"></i> KML
            </a>
            <a href="<?php echo e(route('bts-towers.import-form')); ?>" class="btn-act btn-ghost" style="color:#fbbf24;border-color:rgba(251,191,36,0.2);">
                <i class="fas fa-file-import"></i> Import
            </a>
            <a href="<?php echo e(route('bts-towers.alerts')); ?>" class="btn-act btn-ghost" style="color:#f87171;border-color:rgba(248,113,113,0.2);position:relative;">
                <i class="fas fa-bell"></i> Notifikasi
            </a>
            <a href="<?php echo e(route('bts-towers.create')); ?>" class="btn-act btn-indigo">
    ...
    <div class="stats-row">
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-value" style="color:#34d399;"><?php echo e(number_format($stats['aktif'])); ?></div>
            </div>
        </div>
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-value" style="color:#fbbf24;"><?php echo e(number_format($stats['maintenance'])); ?></div>
            </div>
        </div>
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-value" style="color:#9ca3af;"><?php echo e(number_format($stats['tidak_aktif'])); ?></div>
            </div>
        </div>
    </div>
        ...
        <div class="section-body">
            <form method="GET" class="filter-grid">
                <div class="field">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Nama, kode, atau desa...">
                </div>
                <div class="field">
                    <label><i class="fas fa-map-marker-alt" style="margin-right:4px;"></i> Kecamatan</label>
                    <select name="kecamatan">
                        <option value="">Semua Kecamatan</option>
                        <?php $__currentLoopData = $kecamatanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($k); ?>" <?php if(request('kecamatan') == $k): echo 'selected'; endif; ?>><?php echo e($k); ?></option>
                ...
                <div class="field">
                    ...
                    <select name="provider">
                        ...
                        <?php $__currentLoopData = $providerList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($p); ?>" <?php if(request('provider') == $p): echo 'selected'; endif; ?>><?php echo e($p); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="field">
                    ...
                    <select name="status_operasional">
                        ...
                        <?php $__currentLoopData = $statusList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($s); ?>" <?php if(request('status_operasional') == $s): echo 'selected'; endif; ?>><?php echo e($s); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
    ...
    <div class="section-card">
        <div class="section-header">
            ...
            <div style="display:flex;gap:10px;align-items:center;">
                ...
                <span style="font-size:10px;color:#6b7280;font-weight:600;"><?php echo e($stats['total']); ?> titik</span>
            </div>
        </div>
    ...
    <div class="section-card">
        ...
        <form id="bulkForm" action="<?php echo e(route('bts-towers.bulk-delete')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            ?>
                            <tr>
                                <td style="text-align:center;"><input type="checkbox" class="cb-custom tower-cb" name="tower_ids[]" value="<?php echo e($tower->id); ?>" data-kode="<?php echo e($tower->kode_bts); ?>"></td>
                                <td style="font-family:monospace;font-size:11px;color:#818cf8;"><?php echo e($tower->kode_bts); ?></td>
                                <td>
                                    <div class="tower-name"><?php echo e($tower->nama_bts); ?></div>
                                    <?php if($tower->desa): ?>
                                        <div class="tower-sub"><?php echo e($tower->desa); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <span class="provider-pill">
                                        <span class="provider-dot" style="background:<?php echo e($pc); ?>;"></span>
                                        <?php echo e($tower->provider); ?>

                                    </span>
                                </td>
                                <td><?php echo e($tower->kecamatan); ?></td>
                                <td><span class="badge-c <?php echo e($kondisiClass); ?>"><?php echo e($tower->kondisi ?: '-'); ?></span></td>
                                <td><span class="badge-c <?php echo e($statusClass); ?>"><?php echo e($tower->status_operasional ?: '-'); ?></span></td>
                                <td>
                                    <div class="action-icons">
                                        <a href="<?php echo e(route('bts-towers.show', $tower)); ?>" class="icon-btn icon-info" title="Detail"><i class="fas fa-eye"></i></a>
                                        <a href="<?php echo e(route('bts-towers.edit', $tower)); ?>" class="icon-btn icon-warning" title="Edit"><i class="fas fa-pen"></i></a>
                                        <a href="<?php echo e(route('bts-towers.report', $tower)); ?>" target="_blank" class="icon-btn icon-dark" title="PDF"><i class="fas fa-file-pdf"></i></a>
                                        <form action="<?php echo e(route('bts-towers.destroy', $tower)); ?>" method="POST" onsubmit="return confirm('Yakin hapus data ini?')" style="display:inline;">
        ...
        <form id="compareForm" action="<?php echo e(route('bts-towers.compare')); ?>" method="GET" style="display:none;">
        </form>
...
<script>
    const mapPoints = <?php echo json_encode($mapPoints, 15, 512) ?>;
    ...
    const mapPointsFull = <?php echo json_encode($mapPoints, 15, 512) ?>;
...
<?php echo $__env->make(($isMobile ?? false) ? 'layouts.mobile' : 'layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SI-LARANG\resources\views/bts-towers/index.blade.php ENDPATH**/ ?>