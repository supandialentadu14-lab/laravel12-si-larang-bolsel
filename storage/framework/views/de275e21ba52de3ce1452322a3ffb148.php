...
<head>
    <meta charset="utf-8">
    <title>Laporan BTS - <?php echo e($btsTower->kode_bts); ?></title>
    <style>
...
<body>
    ...
    <div class="header">
        <div class="header-top">
            ...
            <div class="header-badge">
                <?php if(($btsTower->status_operasional ?? '') === 'Aktif'): ?>
                    <span class="badge-box badge-aktif">&#9679; Aktif</span>
                <?php elseif(($btsTower->status_operasional ?? '') === 'Maintenance'): ?>
        ...
        <div class="meta-line">
            <strong>Kode:</strong> <?php echo e($btsTower->kode_bts); ?> &nbsp;&middot;&nbsp;
            <strong>Provider:</strong> <?php echo e($btsTower->provider); ?> &nbsp;&middot;&nbsp;
            <strong>Dicetak:</strong> <?php echo e(now()->translatedFormat('d F Y, H:i')); ?> WITA
        </div>
    </div>
    ...
    <div class="info-grid">
        <div class="info-card">
            ...
            <div class="ic-value"><?php echo e($btsTower->kecamatan); ?></div>
        </div>
        <div class="info-card">
            <div class="ic-label">Tinggi Tower</div>
            <div class="ic-value"><?php echo e($btsTower->tinggi_tower ? $btsTower->tinggi_tower . ' m' : '-'); ?></div>
        </div>
        <div class="info-card">
            <div class="ic-label">Kondisi</div>
            <div class="ic-value">
                <?php if($btsTower->kondisi): ?>
                    <span class="status-pill pill-<?php echo e(str_replace(' ', '-', strtolower($btsTower->kondisi))); ?>"><?php echo e($btsTower->kondisi); ?></span>
                <?php else: ?> -
                <?php endif; ?>
            </div>
        </div>
        <div class="info-card">
            ...
            <div class="ic-value"><?php echo e($btsTower->tahun_dibangun ?: '-'); ?></div>
        </div>
    </div>
    ...
    <table class="detail">
        ...
        <tr><th>Nama BTS</th><td><?php echo e($btsTower->nama_bts); ?></td></tr>
        <tr><th>Provider</th><td><?php echo e($btsTower->provider); ?></td></tr>
        ...
        <tr><th>Koordinat</th><td><?php echo e($btsTower->latitude); ?>, <?php echo e($btsTower->longitude); ?></td></tr>
    </table>
    ...
    <table class="detail">
        <tr>
            <th>Tinggi Tower</th>
            <td><?php echo e($btsTower->tinggi_tower ? $btsTower->tinggi_tower . ' meter' : '-'); ?></td>
        </tr>
        <tr>
            <th>Tipe Tower</th>
            <td><?php echo e($btsTower->tipe_tower ?: '-'); ?></td>
        </tr>
        <tr>
            <th>Tahun Dibangun</th>
            <td><?php echo e($btsTower->tahun_dibangun ?: '-'); ?></td>
        </tr>
        <tr>
            <th>Kondisi Fisik</th>
            <td>
        ...
        <tr>
            ...
            <td>
                <?php if($btsTower->status_operasional): ?>
                    <span class="status-pill pill-<?php echo e(str_replace(' ', '-', strtolower($btsTower->status_operasional))); ?>"><?php echo e($btsTower->status_operasional); ?></span>
                <?php else: ?> -
                <?php endif; ?>
            </td>
        </tr>
    ...
    <?php if($btsTower->keterangan): ?>
        <div class="section-title st-green">Keterangan</div>
        <div class="notes-box"><?php echo nl2br(e($btsTower->keterangan)); ?></div>
    <?php endif; ?>
    ...
    <?php if($mapImage): ?>
        ...
        <div class="map-container">
            <img src="<?php echo e($mapImage); ?>" class="map-img" alt="Peta Lokasi BTS">
    ...
    <div class="footer">
        ...
        Dicetak pada <?php echo e(now()->translatedFormat('d F Y, H:i')); ?> WITA
    </div>

</body>
</html>
<?php /**PATH D:\SI-LARANG\resources\views/bts-towers/pdf.blade.php ENDPATH**/ ?>