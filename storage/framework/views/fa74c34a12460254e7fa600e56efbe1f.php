...
<head>
  ...
  <title>SIMPATI</title>
  <link rel="icon" type="image/png" href="<?php echo e(asset('images/simpatis.png')); ?>">
  ...
  <link rel="preload" href="<?php echo e(asset('images/simpatis.png')); ?>" as="image" type="image/png">
  <link rel="preload" href="<?php echo e(asset('images/login-bg-neww.png')); ?>" as="image" type="image/png">
...
<body class="bg-slate-50 text-slate-900 selection:bg-indigo-100 selection:text-indigo-900" x-data="{ mobileMenu: false }">
  ...
  <nav class="fixed top-0 w-full z-50 transition-all duration-300"
    ...
    <div class="w-full max-w-none px-6 md:px-12 lg:px-20 mx-auto flex justify-between items-center">
      <div class="flex items-center gap-3">
        <img src="<?php echo e(asset('images/simpatis.png')); ?>" alt="Logo" class="h-10 w-10 object-contain" width="40" height="40" decoding="async" fetchpriority="high">
      ...
      <div class="hidden md:flex items-center gap-8">
        ...
        <a href="<?php echo e(route('login')); ?>" class="px-6 py-2.5 bg-indigo-600 text-white text-sm font-black rounded-full shadow-lg shadow-indigo-200 hover:bg-slate-800 transition transform hover:-translate-y-0.5">MASUK</a>
      </div>
    ...
    <div class="md:hidden bg-white/95 backdrop-blur-xl absolute top-full left-0 w-full border-b border-slate-100 py-6 px-6 space-y-4"
      ...
      <a href="<?php echo e(route('login')); ?>" class="block w-full py-4 bg-indigo-600 text-white text-center font-black rounded-2xl shadow-lg">MASUK</a>
    </div>
  </nav>
    ...
    <div class="w-full max-w-none px-6 md:px-12 lg:px-20 mx-auto relative z-10 grid md:grid-cols-2 gap-12 items-center">
      <div class="animate__animated animate__fadeInLeft">
        ...
        <div class="flex items-center gap-6 mb-6">
          <img src="<?php echo e(asset('images/bolsel.webp')); ?>" alt="Bolsel" class="h-16 w-auto contrast-125 opacity-70" width="150" height="64" loading="lazy" decoding="async">
        ...
        <div class="flex flex-wrap gap-4">
          <a href="<?php echo e(route('login')); ?>" class="px-8 py-4 bg-indigo-600 text-white font-black rounded-2xl shadow-2xl shadow-indigo-200 hover:bg-slate-800 transition transform hover:-translate-y-1">
      ...
      <div class="relative animate__animated animate__fadeInRight hero-image-container">
        <div class="relative w-full max-w-lg mx-auto">
          ...
          <div class="relative bg-white rounded-[1.5rem] md:rounded-[4rem] shadow-2xl border border-slate-50 overflow-hidden">
            <img src="<?php echo e(asset('images/login-bg-neww.png')); ?>" class="w-full h-auto block" fetchpriority="high" width="800" height="600" decoding="async">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="w-full max-w-none px-6 md:px-12 lg:px-20 mx-auto">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
        <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 text-center hover:shadow-lg transition">
          ...
          <p class="text-3xl font-black text-slate-900"><?php echo e(number_format($btsTotal)); ?></p>
        ...
        <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 text-center hover:shadow-lg transition">
          ...
          <p class="text-3xl font-black text-emerald-600"><?php echo e(number_format($btsAktif)); ?></p>
        ...
        <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 text-center hover:shadow-lg transition">
          ...
          <p class="text-3xl font-black text-amber-600"><?php echo e($btsProvider->count()); ?></p>
      ...
      <div class="grid md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
          ...
          <div class="space-y-3">
            <?php $__empty_1 = true; $__currentLoopData = $btsKecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <?php $pct = $btsTotal > 0 ? ($item->total / $btsTotal) * 100 : 0; ?>
              <div>
                <div class="flex justify-between mb-1">
                  <span class="text-[11px] font-bold text-slate-600 uppercase"><?php echo e($item->kecamatan); ?></span>
                  <span class="text-[11px] font-black text-slate-900"><?php echo e($item->total); ?></span>
                </div>
                <div class="h-2.5 bg-slate-100 rounded-full overflow-hidden">
                  <div class="stat-bar bg-indigo-500" style="width: <?php echo e($pct); ?>%"></div>
                </div>
              </div>
        ...
        <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
          ...
          <div class="space-y-3">
            <?php $providerColors = ['Telkomsel'=>'#e74c3c','Indosat'=>'#f39c12','XL Axiata'=>'#3498db','Tri (3)'=>'#9b59b6','Smartfren'=>'#2ecc71','Lainnya'=>'#95a5a6']; ?>
            <?php $__empty_1 = true; $__currentLoopData = $btsProvider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <?php
              ...
              <div>
                <div class="flex justify-between mb-1">
                  <span class="text-[11px] font-bold text-slate-600 uppercase flex items-center gap-2">
                    <span class="w-2.5 h-2.5 rounded-full inline-block" style="background:<?php echo e($color); ?>"></span><?php echo e($item->provider); ?>

                  </span>
                  <span class="text-[11px] font-black text-slate-900"><?php echo e($item->total); ?></span>
                </div>
                <div class="h-2.5 bg-slate-100 rounded-full overflow-hidden">
                  <div class="stat-bar" style="width: <?php echo e($pct); ?>%; background: <?php echo e($color); ?>;"></div>
                </div>
              </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
              <p class="text-xs text-slate-400 font-bold text-center py-4">Belum ada data</p>
      ...
      <div class="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
        ...
        <div class="relative">
          ...
          <div class="relative bg-white rounded-[2rem] shadow-lg border border-slate-100 overflow-hidden group">
            <img src="<?php echo e(asset('images/login-bg-neww.png')); ?>" class="w-full h-auto block transform group-hover:scale-105 transition duration-700" loading="lazy" width="800" height="600" decoding="async">
          </div>
        </div>
      </div>
    </div>
  ...
  <footer class="py-12 bg-slate-900 text-white">
    <div class="w-full max-w-none px-6 md:px-12 lg:px-20 mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
      <div class="flex items-center gap-3">
        <img src="<?php echo e(asset('images/simpatis.png')); ?>" alt="Logo" class="h-8 w-8 object-contain" loading="lazy" width="32" height="32" decoding="async">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      const btsTotal = <?php echo e($btsTotal); ?>;
      ...
      const allPoints = <?php echo json_encode($allBtsPoints, 15, 512) ?>;
...
<?php /**PATH D:\SI-LARANG\resources\views/landing.blade.php ENDPATH**/ ?>