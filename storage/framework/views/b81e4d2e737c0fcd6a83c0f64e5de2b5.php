...
<div class="container-fluid py-4 bts-compare">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Membandingkan <span><?php echo e(count($towers)); ?></span> menara</p>
        </div>
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
            <a href="<?php echo e(route('bts-towers.index')); ?>" class="btn-nav btn-ghost">
    ...
    <?php if(empty($towers) || count($towers) < 2): ?>
                ...
                <table class="compare-tbl">
                    <thead>
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <th>
                                    <div class="th-inner">
                                        <span class="th-name"><?php echo e($tower->nama_bts); ?></span>
                                        <span class="th-sub"><?php echo e($tower->kode_bts); ?></span>
                                    </div>
                                </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value"><span class="tower-kode"><?php echo e($tower->kode_bts); ?></span></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value"><span class="tower-nama"><?php echo e($tower->nama_bts); ?></span></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value">
                                    <span class="provider-dot" style="background:<?php echo e($providerColors[$tower->provider] ?? '#95a5a6'); ?>;"></span><?php echo e($tower->provider); ?>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value"><?php echo e($tower->kecamatan ?: '-'); ?></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value"><?php echo e($tower->desa ?: '-'); ?></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value">
                                    <?php if($tower->latitude && $tower->longitude): ?>
                                        <span class="coord-text"><?php echo e($tower->latitude); ?>, <?php echo e($tower->longitude); ?></span>
                                        <a href="https://www.google.com/maps?q=<?php echo e($tower->latitude); ?>,<?php echo e($tower->longitude); ?>" target="_blank" class="coord-link" title="Buka di Google Maps">
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value"><?php echo e($tower->tinggi_tower ? $tower->tinggi_tower . ' m' : '-'); ?></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value"><?php echo e($tower->tipe_tower ?: '-'); ?></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value">
                                    <?php if($tower->kondisi): ?>
                                        <span class="badge <?php echo e($tower->kondisi === 'Baik' ? 'badge-baik' : ($tower->kondisi === 'Rusak Berat' ? 'badge-rusak-berat' : 'badge-rusak-ringan')); ?>">
                                            <?php echo e($tower->kondisi); ?>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value">
                                    <?php if($tower->status_operasional): ?>
                                        <span class="badge <?php echo e($tower->status_operasional === 'Aktif' ? 'badge-aktif' : ($tower->status_operasional === 'Maintenance' ? 'badge-maintenance' : 'badge-tidak-aktif')); ?>">
                                            <?php echo e($tower->status_operasional); ?>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value"><?php echo e($tower->tahun_dibangun ?: '-'); ?></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value">
                                    <span class="count-badge">
                                        <i class="fas fa-file-alt"></i> <?php echo e(optional($tower->notes)->count()); ?>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value"><?php echo e($tower->radius_cakupan ? $tower->radius_cakupan . ' km' : '-'); ?></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $towers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="row-value">
                                    <?php if($tower->foto_url): ?>
                                        <img src="<?php echo e($tower->foto_url); ?>" alt="<?php echo e($tower->nama_bts); ?>" class="thumb-photo">
                                    <?php else: ?>
                ...
                <div class="m-card">
                    <div class="m-card-header">
                        <div>
                            <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
                                <span class="badge <?php echo e(($tower->status_operasional ?? '') === 'Aktif' ? 'badge-aktif' : (($tower->status_operasional ?? '') === 'Maintenance' ? 'badge-maintenance' : 'badge-tidak-aktif')); ?>" style="font-size:9px;padding:2px 8px;">
                                    <i class="fas fa-signal"></i> <?php echo e($tower->status_operasional ?? '-'); ?>

                                </span>
                            </div>
                            <div class="tower-nama" style="font-size:1.1rem;"><?php echo e($tower->nama_bts); ?></div>
                            <div class="tower-kode" style="margin-top:2px;"><?php echo e($tower->kode_bts); ?></div>
                        </div>
                        <?php if($tower->foto_url): ?>
                            <img src="<?php echo e($tower->foto_url); ?>" alt="<?php echo e($tower->nama_bts); ?>" class="thumb-photo" style="width:56px;height:56px;">
                        <?php else: ?>
                    ...
                    <div class="m-card-body">
                        ...
                        <div class="m-row">
                            ...
                            <span class="m-row-value"><?php echo e($tower->kecamatan ?: '-'); ?></span>
                        </div>
                        <div class="m-row">
                            <span class="m-row-label">Desa</span>
                            <span class="m-row-value"><?php echo e($tower->desa ?: '-'); ?></span>
                        </div>
                        <div class="m-row">
                            ...
                            <span class="m-row-value">
                                <?php if($tower->latitude && $tower->longitude): ?>
                                    <span class="coord-text"><?php echo e($tower->latitude); ?>, <?php echo e($tower->longitude); ?></span>
                                    <a href="https://www.google.com/maps?q=<?php echo e($tower->latitude); ?>,<?php echo e($tower->longitude); ?>" target="_blank" class="coord-link"><i class="fas fa-external-link-alt"></i></a>
                                <?php else: ?> -
                                <?php endif; ?>
                            </span>
                        </div>
                        <div class="m-row">
                            ...
                            <span class="m-row-value"><?php echo e($tower->tinggi_tower ? $tower->tinggi_tower . ' m' : '-'); ?></span>
                        </div>
                        <div class="m-row">
                            <span class="m-row-label">Tipe Tower</span>
                            <span class="m-row-value"><?php echo e($tower->tipe_tower ?: '-'); ?></span>
                        </div>
                        <div class="m-row">
                            <span class="m-row-label">Kondisi</span>
                            <span class="m-row-value">
                                <?php if($tower->kondisi): ?>
                                    <span class="badge <?php echo e($tower->kondisi === 'Baik' ? 'badge-baik' : ($tower->kondisi === 'Rusak Berat' ? 'badge-rusak-berat' : 'badge-rusak-ringan')); ?>"><?php echo e($tower->kondisi); ?></span>
                                <?php else: ?> -
                                <?php endif; ?>
                            </span>
                        </div>
                        <div class="m-row">
                            ...
                            <span class="m-row-value">
                                <?php if($tower->status_operasional): ?>
                                    <span class="badge <?php echo e($tower->status_operasional === 'Aktif' ? 'badge-aktif' : ($tower->status_operasional === 'Maintenance' ? 'badge-maintenance' : 'badge-tidak-aktif')); ?>"><?php echo e($tower->status_operasional); ?></span>
                                <?php else: ?> -
                                <?php endif; ?>
                            </span>
                        </div>
                        <div class="m-row">
                            ...
                            <span class="m-row-value"><?php echo e($tower->tahun_dibangun ?: '-'); ?></span>
                        </div>
                        <div class="m-row">
                            <span class="m-row-label">Catatan</span>
                            <span class="m-row-value">
                                <span class="count-badge"><i class="fas fa-file-alt"></i> <?php echo e(optional($tower->notes)->count()); ?></span>
                            </span>
                        </div>
                        <div class="m-row">
                            <span class="m-row-label">Radius Cakupan</span>
                            <span class="m-row-value"><?php echo e($tower->radius_cakupan ? $tower->radius_cakupan . ' km' : '-'); ?></span>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make(($isMobile ?? false) ? 'layouts.mobile' : 'layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SI-LARANG\resources\views/bts-towers/compare.blade.php ENDPATH**/ ?>