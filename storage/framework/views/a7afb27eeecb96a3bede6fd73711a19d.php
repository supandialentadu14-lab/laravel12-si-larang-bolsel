<?php $__env->startSection('content'); ?>
  ...
  <div class="space-y-6 pb-24">
    ...
    <form method="POST" action="<?php echo e(route('reports.opname.save', $id)); ?>" x-data="opnameForm()" x-init="$nextTick(() => updatePembuka())" class="space-y-6">
      <?php echo csrf_field(); ?>
...
<?php echo $__env->make($isMobile ? 'layouts.mobile' : 'layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SI-LARANG\resources\views/opname/edit.blade.php ENDPATH**/ ?>