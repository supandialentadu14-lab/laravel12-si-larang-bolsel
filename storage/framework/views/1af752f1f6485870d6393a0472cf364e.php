            ...
            <div class="bts-grid">
                <?php if($tower): ?>
                    <div class="c-4 field">
                        ...
                        <input type="text" value="<?php echo e($tower->kode_bts); ?>" disabled style="opacity:.7; cursor:not-allowed;">
                ...
                <?php else: ?>
                    <div class="c-4 field">
                        ...
                        <div class="hint">Format: BTS-BOLSEL-<?php echo e(date('Y')); ?>-XXX</div>
                    </div>
                <?php endif; ?>
                <div class="c-6 field">
                    <label>Nama BTS <span class="req">*</span></label>
                    <input type="text" id="nama_bts_input" name="nama_bts" value="<?php echo e(old('nama_bts', $tower->nama_bts ?? '')); ?>" data-auto="<?php echo e($tower ? 'false' : 'true'); ?>" required placeholder="Otomatis mengikuti alamat / bisa diketik manual">
                ...
                <div class="c-4 field">
                    ...
                    <select name="provider" required>
                        <?php $__currentLoopData = $providerList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($p); ?>" <?php if(old('provider', $tower->provider ?? '') == $p): echo 'selected'; endif; ?>><?php echo e($p); ?></option>
                ...
                <div class="c-4 field">
                    ...
                    <input type="text" name="nama_perusahaan" value="<?php echo e(old('nama_perusahaan', $tower->nama_perusahaan ?? '')); ?>" placeholder="Opsional">
                </div>
                ...
                <div class="c-4 field">
                    ...
                    <select name="kecamatan" id="kecamatan_select" required>
                        ...
                        <?php $__currentLoopData = $kecamatanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($k); ?>" <?php if(old('kecamatan', $tower->kecamatan ?? '') == $k): echo 'selected'; endif; ?>><?php echo e($k); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="c-4 field">
                    <label>Desa/Kelurahan</label>
                    <input type="text" name="desa" id="desa_input" value="<?php echo e(old('desa', $tower->desa ?? '')); ?>" placeholder="Opsional">
                </div>

                <div class="c-12 field">
                    <label>Alamat Lengkap</label>
                    <textarea name="alamat" id="alamat_textarea" rows="2" placeholder="Jalan, patokan, atau alamat detail lokasi tower"><?php echo e(old('alamat', $tower->alamat ?? '')); ?></textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="section-body">
            ...
            <div class="bts-grid" style="margin-top:16px;">
                <div class="c-6 field">
                    ...
                    <input type="text" id="latitude" name="latitude" value="<?php echo e(old('latitude', $tower->latitude ?? '')); ?>" required placeholder="0.4317000">
                </div>
                <div class="c-6 field">
                    <label>Longitude <span class="req">*</span></label>
                    <input type="text" id="longitude" name="longitude" value="<?php echo e(old('longitude', $tower->longitude ?? '')); ?>" required placeholder="123.4817000">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="section-body">
            <div class="bts-grid">
                <div class="c-3 field">
                    ...
                    <div class="unit-wrap">
                        <input type="number" step="0.01" name="tinggi_tower" value="<?php echo e(old('tinggi_tower', $tower->tinggi_tower ?? '')); ?>" placeholder="0">
                        <span>meter</span>
                    </div>
                </div>
                <div class="c-3 field">
                    <label>Tahun Dibangun</label>
                    <input type="number" name="tahun_dibangun" value="<?php echo e(old('tahun_dibangun', $tower->tahun_dibangun ?? '')); ?>" min="1990" max="<?php echo e(date('Y') + 1); ?>" placeholder="<?php echo e(date('Y')); ?>">
                </div>
                <div class="c-3 field">
                    <label>Tipe Tower</label>
                    <input type="text" name="tipe_tower" list="tipe-tower-options" value="<?php echo e(old('tipe_tower', $tower->tipe_tower ?? '')); ?>" placeholder="Pilih dari daftar atau ketik manual">
                    <datalist id="tipe-tower-options">
                        <?php $__currentLoopData = $tipeTowerList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="c-3 field">
                    ...
                    <select name="kondisi">
                        ...
                        <?php $__currentLoopData = $kondisiList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($k); ?>" <?php if(old('kondisi', $tower->kondisi ?? '') == $k): echo 'selected'; endif; ?>><?php echo e($k); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div class="c-4 field">
                    ...
                    <select name="status_operasional">
                        ...
                        <?php $__currentLoopData = $statusList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($s); ?>" <?php if(old('status_operasional', $tower->status_operasional ?? '') == $s): echo 'selected'; endif; ?>><?php echo e($s); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="c-3 field">
                    ...
                    <div class="unit-wrap">
                        <input type="number" step="0.1" name="coverage_radius" value="<?php echo e(old('coverage_radius', $tower->coverage_radius ?? '')); ?>" placeholder="0" min="0" max="50">
                        <span>km</span>
                    </div>
        ...
        <div class="section-body">
            <div class="bts-grid">
                <div class="c-6 field">
                    ...
                    <?php if(!empty($tower?->foto)): ?>
                        <img src="<?php echo e($tower->foto_url); ?>" class="photo-preview">
                    <?php endif; ?>
                </div>
                <div class="c-6 field">
                    <label>Keterangan</label>
                    <textarea name="keterangan" rows="4" placeholder="Catatan tambahan, misalnya akses jalan, kondisi khusus, dsb"><?php echo e(old('keterangan', $tower->keterangan ?? '')); ?></textarea>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\SI-LARANG\resources\views/bts-towers/_form.blade.php ENDPATH**/ ?>