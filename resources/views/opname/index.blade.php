...
@section('content')
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
        ...
        <div class="w-full lg:max-w-xl">
            <form action="{{ route('reports.opname.list') }}" method="GET" class="relative group">
                <div x-data="{ query: '{{ request('search') }}' }" class="relative">
                    ...
                    <span x-show="query" @click="location.href='{{ route('reports.opname.list') }}'" class="absolute inset-y-0 right-0 flex items-center pr-4 text-slate-300 cursor-pointer hover:text-rose-500 transition-colors">
