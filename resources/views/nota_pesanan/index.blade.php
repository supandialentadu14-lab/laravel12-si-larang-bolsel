...
@section('content')
    ...
    toggleAll() {
        ...
        <div class="flex items-center gap-2 w-full sm:w-auto">
            <a href="{{ route('reports.nota.form') }}" class="inline-flex justify-center w-full sm:w-auto items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg font-bold shadow">
                <i class="fas fa-plus"></i> <span class="whitespace-nowrap">Buat Nota Pesanan</span>
            </a>
        </div>
