...
<div class="container-fluid py-4 bts-form-page">
    ...
    <form action="{{ route('bts-towers.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div style="display:flex;gap:10px;margin-top:1.25rem;">
            ...
            <a href="{{ route('bts-towers.index') }}" class="btn-act btn-ghost" style="padding:11px 28px;">
                Batal
            </a>
        </div>
    </form>
...
@include('bts-towers._map-picker-script', ['lat' => old('latitude'), 'lng' => old('longitude')])
@endpush
@endsection
