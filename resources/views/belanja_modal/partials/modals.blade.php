{{-- Modal Form Spreadsheet (Optimized for Mobile) --}}
<div x-show="showModal" style="display: none;" class="fixed inset-0 z-[10000] overflow-y-auto" x-cloak>
    <div class="flex items-end sm:items-center justify-center min-h-screen text-center">
        ...
        <div x-show="showModal" 
            ...
            class="relative w-full sm:max-w-6xl bg-white rounded-t-[2.5rem] sm:rounded-[2.5rem] text-left overflow-hidden shadow-2xl p-6 sm:p-8">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <button @click="showModal = false" class="w-10 h-10 rounded-2xl bg-slate-50 text-slate-400 flex items-center justify-center">
            ...
            <form method="POST" action="{{ route('reports.belanja.modal.save') }}" class="space-y-6">
                ...
                {{-- Desktop View Table (Still used for layout but scrollable) --}}
                                ...
                                <tbody class="bg-white divide-y divide-slate-50">
                                    <template x-for="(item, i) in items" :key="i">
                                        <tr class="hover:bg-slate-50/50 transition-colors">
                                            <td class="px-2 py-2 min-w-[250px] space-y-1">
                                            ...
                                            <td class="px-2 py-2 space-y-1 min-w-[140px]">
                                            ...
                                            <td class="px-2 py-2">
                                                <div class="grid grid-cols-2 gap-1 min-w-[200px]">
