    ...
    <div class="space-y-6 pb-24">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mt-1">Perbarui Kwitansi</p>
            </div>
        ...
        <form action="{{ route('reports.kwitansi.update', $id) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="flex gap-3 px-2">
                ...
                <button type="submit" class="flex-[2] py-5 bg-indigo-600 text-white rounded-[1.5rem] text-[11px] font-black uppercase tracking-[0.2em] shadow-xl shadow-indigo-100 active:scale-95 transition-all">Perbarui Kwitansi</button>
            </div>
        </form>
    </div>
@endsection
