...
@section('extra_buttons')
    @if(session('bap_current_id'))
        <a href="{{ route('reports.paket.show', session('bap_current_id')) }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-emerald-600 text-white hover:bg-emerald-700 transition font-bold text-xs">
