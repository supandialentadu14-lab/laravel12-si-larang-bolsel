  ...
  <div class="space-y-6 pb-24">
    ...
    <form action="{{ route('reports.pemeriksaan.save') }}" method="POST" class="space-y-6">
      ...
      <div class="flex gap-3 px-2">
        ...
        <button type="submit" class="flex-[2] py-5 bg-indigo-600 text-white rounded-[1.5rem] text-[11px] font-black uppercase tracking-[0.2em] shadow-xl shadow-indigo-100 dark:shadow-none active:scale-95 transition-all">Simpan BAP</button>
      </div>
    </form>
  </div>
@endsection
