                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="mt-4 space-y-2">
                            <div class="flex items-center gap-2 text-slate-500">
                                ...
                                <span class="text-[10px] font-bold text-slate-600 truncate">{{ $row['nota_nomor'] }}</span>
                            </div>
                            ...
                            <div class="flex items-center justify-between pt-2 border-t border-slate-50">
                                ...
                                <div class="flex items-center gap-1.5">
                                    <a href="{{ route('reports.pemeriksaan.show', $row['id']) }}" class="w-9 h-9 rounded-xl bg-slate-50 text-slate-400 flex items-center justify-center hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
                                        <i class="fas fa-eye text-[10px]"></i>
                                    </a>
                                    <a href="{{ route('reports.pemeriksaan.edit', $row['id']) }}" class="w-9 h-9 rounded-xl bg-slate-50 text-slate-400 flex items-center justify-center hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
