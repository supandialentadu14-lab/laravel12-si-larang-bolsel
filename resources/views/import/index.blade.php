...
<div class="space-y-6 max-w-2xl mx-auto pb-20">
  ...
  <div class="flex items-center justify-between px-2">
    ...
    <a href="{{ route('products.index') }}" class="w-10 h-10 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center justify-center text-slate-400 active:scale-90 transition-all">
